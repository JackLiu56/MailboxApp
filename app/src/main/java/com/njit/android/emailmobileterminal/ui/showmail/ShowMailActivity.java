...
import com.njit.android.emailmobileterminal.ui.fetchmailbox.Email;
...
public class ShowMailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textViewContent = findViewById(R.id.text_content_value);
            ...
            public void run() {
                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        textViewContent.setText(Html.fromHtml(mailContent));
                    }
                });
            }
        }).start();
    ...
    private Email getEmailOjectWithMessage(){
        ...
        try{
            ...
            Message[] mess;
            try{
                myApplication.getFetchEmail().login(HOST_STRING,myApplication.getUserName(),myApplication.getPassword());
